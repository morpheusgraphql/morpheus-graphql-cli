...
resolveMutation = return Mutation
  { createDeity     = const $ toMutResolver
                        [Event { channels = [Channel], content = Content }]
                        resolveDeity
  , createCharacter = const $ toMutResolver
                        [Event { channels = [Channel], content = Content }]
                        resolveCharacter
  }
...
resolveSubscription = return Subscription
  { newDeity     = const
                     $ Event { channels = [Channel], content = const resolveDeity }
  , newCharacter = const $ Event { channels = [Channel]
                                 , content  = const resolveCharacter
                                 }
  }
